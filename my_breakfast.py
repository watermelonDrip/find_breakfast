...
class s_report(wx.Frame):
    def __init__(self):
       ...
       # wx.StaticText(self.panel, -1,
         ...
         #             pos=(10, 10))
        wx.StaticText(self.panel, -1, "Please enter dishes:", pos=(10, 70))

        wx.StaticText(self.panel, -1, "first guess:", pos=(10, 100))
        wx.StaticText(self.panel, -1, "second guess:", pos=(10, 125))
